...
public class Admin extends AppCompatActivity {
    ...
    String url = "http://10.0.3.2:8080/myproject/adminlog.php";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonarray.length(); i++) {
                                ...
                                String email = respons.getString("username");
                                one.add(email);
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < one.size(); i++) {
                    if (email.equals(one.get(i)) && password.equals(two.get(i))) {
                        count++;
                        Intent x = new Intent(Admin.this, Adminfirst.class);
                        startActivity(x);
                    }
                ...
                if (count == 0) {
                    Toast.makeText(Admin.this, "check your email and password", Toast.LENGTH_SHORT).show();
