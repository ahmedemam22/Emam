...
public class Edit_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text3 = findViewById(R.id.confirm);
        ...
        SharedPreferences shared=getApplicationContext().getSharedPreferences("email",0);
email=shared.getString("email","");
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(text2.getText().toString().equals(text3.getText().toString())){
                    ...
                    params.put("mobile",text4.getText().toString());
                    params.put("new",text1.getText().toString());
                    ...
                    Toast.makeText(Edit_profile.this," please matche your password", Toast.LENGTH_SHORT).show();
                }
...

    {
        ...
        {
            try {
                URL url = new URL("http://10.0.3.2:8080/myproject/update_student.php");//=" + arg0[0] + "&lname=" + arg0[1]+"&email="+arg0[2]+"&password="+arg0[3]+"&grade="+arg0[4]+"&college="+college+"&mobile="+arg0[6]+"&distance="+arg0[7]);
